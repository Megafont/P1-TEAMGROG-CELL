...
/// </summary>
[Serializable]
[CreateAssetMenu(fileName = "New Wave Info (OLD)", menuName = "Enemy Spawning Assets/New WaveInfo Asset (OLD)")]
public class EnemyWaveInfo_OLD : ScriptableObject
{
    ...
    public List<EnemySpawnInfo_OLD> Enemies = new List<EnemySpawnInfo_OLD>();
}
